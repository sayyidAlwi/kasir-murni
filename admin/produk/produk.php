  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h1 class="modal-title fs-5" id="exampleModal">Modal title</h1>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <div class="modal fade" id="edit<?= $datas['id'] ?>" tabindex="100" aria-labelledby="editModalLabel<?= $datas['id'] ?>" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
